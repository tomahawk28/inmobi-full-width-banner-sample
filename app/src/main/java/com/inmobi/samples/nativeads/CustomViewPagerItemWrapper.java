 ...
 * transformed.
 * <p/>
 * Since this class is only used within the FancyPagerAdapter it doesn't need to check if there are multiple
 * children or not (there can only be one at all times).
 */
@SuppressWarnings("ConstantConditions")
class CustomViewPagerItemWrapper extends ViewGroup {
    ...
    public CustomViewPagerItemWrapper(Context context) {
        super(context);
        this.init();
    }

    public CustomViewPagerItemWrapper(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }

    public CustomViewPagerItemWrapper(Context context, AttributeSet attrs, int defStyle) {
