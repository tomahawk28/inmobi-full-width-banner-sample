...
public class CustomViewPager extends ViewPager {
    ...
    /**
     * Use this to provide a {@link PhotoPagesFragment.CustomPagerAdapter} to the coverflow. This
     * method will throw an {@link ClassCastException} if the passed adapter does not
     * subclass {@link PhotoPagesFragment.CustomPagerAdapter}.
     *
     * @param adapter
     */
    @Override
    public void setAdapter(PagerAdapter adapter) {
        if (!(adapter instanceof PhotoPagesFragment.CustomPagerAdapter)) {
            throw new ClassCastException(CustomViewPager.class.getSimpleName() +
                    " only works in conjunction with a " +
                    PhotoPagesFragment.CustomPagerAdapter.class.getSimpleName());
        }
